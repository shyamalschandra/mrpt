...
mrpt::img::CImage* mrpt::gui::wxImage2MRPTImage(const wxImage& img)
{
	...
	newImg->loadFromMemoryBuffer(
		lx, ly, true, img.GetData(), true /* swap RB */);
...
CPanelCameraSelection::CPanelCameraSelection(wxWindow* parent, wxWindowID id)
{
	...
	FlexGridSizer10->Add(
		opencvCamIndex, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	StaticText3 = new wxStaticText(
		Panel2, ID_STATICTEXT3, _("Camera type:"), wxDefaultPosition,
	...
	FlexGridSizer10->Add(
		cbOpencvCamType, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	StaticText6 = new wxStaticText(
		Panel2, ID_STATICTEXT6, _("Resolution:"), wxDefaultPosition,
	...
	Panel3 = new wxPanel(
		pagesCameras, ID_PANEL3, wxDefaultPosition, wxDefaultSize,
		wxTAB_TRAVERSAL, _T("ID_PANEL3"));
	FlexGridSizer11 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer11->AddGrowableCol(0);
	StaticText7 = new wxStaticText(
		Panel3, ID_STATICTEXT7, _("IP Camera URL:"), wxDefaultPosition,
	...
	Panel4 = new wxPanel(
		pagesCameras, ID_PANEL4, wxDefaultPosition, wxDefaultSize,
	...
	Panel5 = new wxPanel(
		pagesCameras, ID_PANEL5, wxDefaultPosition, wxDefaultSize,
		wxTAB_TRAVERSAL, _T("ID_PANEL5"));
	FlexGridSizer12 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer12->AddGrowableCol(0);
	StaticText8 = new wxStaticText(
		Panel5, ID_STATICTEXT8, _("Video file to open:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer12->Add(
		StaticText8, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	...
	Panel6 = new wxPanel(
		pagesCameras, ID_PANEL6, wxDefaultPosition, wxDefaultSize,
		wxTAB_TRAVERSAL, _T("ID_PANEL6"));
	...
	Panel1 = new wxPanel(
		pagesCameras, ID_PANEL7, wxDefaultPosition, wxDefaultSize,
	...
	rbBumblebeeSel = new wxRadioBox(
		Panel1, ID_RADIOBOX1, _("Select monocular input"), wxDefaultPosition,
	...
	rbSR_usb = new wxRadioBox(
		pnSwissRanger, ID_RADIOBOX2, _("Connection"), wxDefaultPosition,
		wxDefaultSize, 2, __wxRadioBoxChoices_2, 1, 0, wxDefaultValidator,
		_T("ID_RADIOBOX2"));
	FlexGridSizer2->Add(
		rbSR_usb, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	StaticText4 = new wxStaticText(
		pnSwissRanger, ID_STATICTEXT4, _("IP:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer2->Add(
		StaticText4, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	edSR_IP = new wxTextCtrl(
		pnSwissRanger, ID_TEXTCTRL4, _("192.168.2.14"), wxDefaultPosition,
		wxSize(120, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
	FlexGridSizer2->Add(
		edSR_IP, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer1 = new wxStaticBoxSizer(
		wxHORIZONTAL, pnSwissRanger, _("Channels to grab: "));
	FlexGridSizer3 = new wxFlexGridSizer(4, 1, 0, 0);
	cbSR_chIntensity = new wxCheckBox(
		pnSwissRanger, ID_CHECKBOX3, _("Grayscale intensity"),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_CHECKBOX3"));
	cbSR_chIntensity->SetValue(true);
	cbSR_chIntensity->Disable();
	FlexGridSizer3->Add(
		cbSR_chIntensity, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
	cbSR_ch3D = new wxCheckBox(
		pnSwissRanger, ID_CHECKBOX4, _("3D point cloud"), wxDefaultPosition,
	...
	cbSR_chRange = new wxCheckBox(
		pnSwissRanger, ID_CHECKBOX5, _("Depth image"), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX5"));
	cbSR_chRange->SetValue(false);
	FlexGridSizer3->Add(
		cbSR_chRange, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
	cbSR_chConf = new wxCheckBox(
		pnSwissRanger, ID_CHECKBOX6, _("Confidence"), wxDefaultPosition,
	...
	pnKinect = new wxPanel(
		pagesCameras, ID_PANEL8, wxDefaultPosition, wxDefaultSize,
		wxTAB_TRAVERSAL, _T("ID_PANEL8"));
	FlexGridSizer4 = new wxFlexGridSizer(2, 3, 0, 0);
	StaticBoxSizer2 =
		new wxStaticBoxSizer(wxHORIZONTAL, pnKinect, _("Channels to grab: "));
	FlexGridSizer5 = new wxFlexGridSizer(4, 1, 0, 0);
	cbKinect_Int = new wxCheckBox(
		pnKinect, ID_CHECKBOX7, _("Intensity"), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX7"));
	cbKinect_Int->SetValue(true);
	cbKinect_Int->Disable();
	FlexGridSizer5->Add(
		cbKinect_Int, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
	cbKinect_3D = new wxCheckBox(
		pnKinect, ID_CHECKBOX8, _("3D point cloud"), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX8"));
	cbKinect_3D->SetValue(false);
	FlexGridSizer5->Add(
		cbKinect_3D, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
	cbKinect_Depth = new wxCheckBox(
		pnKinect, ID_CHECKBOX9, _("Depth image"), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX9"));
	...
	rbKinect_int = new wxRadioBox(
		...
		wxDefaultSize, 2, __wxRadioBoxChoices_3, 1, 0, wxDefaultValidator,
		_T("ID_RADIOBOX3"));
	rbKinect_int->SetSelection(0);
	FlexGridSizer4->Add(
		rbKinect_int, 1, wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
	...
	FlexGridSizer1->Add(
		pagesCameras, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
...
void CPanelCameraSelection::OnbtnBrowseRawlogClick(wxCommandEvent& event)
{
	...
	if (dialog.ShowModal() == wxID_OK)
	{
		...
		if (!mrpt::system::directoryExists(
				string(edRawlogImgDir->GetValue().mb_str())))
		{
...
{
	wxDirDialog dialog(
		this, wxT("Choose the rawlog directory with external images"),
		edRawlogImgDir->GetValue(), wxDD_DEFAULT_STYLE);
	...
	const std::string& sect, mrpt::config::CConfigFileBase* cfg) const
{
	...
	switch (this->pagesCameras->GetSelection())
	{
		...
		case 0:
		{
			...
			cfg->write(
				sect, "cv_camera_index",
				format("%i", this->opencvCamIndex->GetValue()));
			cfg->write(
				sect, "cv_camera_type",
		...
		case 1:
		{
			...
			cfg->write(
				sect, "ffmpeg_url",
				string(this->edIPcamURL->GetValue().mb_str()));
		}
		break;
		...
		case 3:
		{
			...
			cfg->write(
				sect, "ffmpeg_url",
				string(this->edVideoFile->GetValue().mb_str()));
		}
		break;
		...
		case 4:
		{
			...
			cfg->write(
				sect, "rawlog_file",
				string(this->edRawlogFile->GetValue().mb_str()));

			const string rawlog_lb =
				string(this->edRawlogLabel->GetValue().mb_str());
			if (!rawlog_lb.empty())
		...
		case 5:
		{
			...
			cfg->write(
				sect, "bumblebee_get_rectified",
				this->cbBumblebeeRectif->GetValue());
		}
		break;
		...
		case 7:
		{
			...
			cfg->write(
				sect, "kinect_video_rgb",
				rbKinect_int->GetSelection() == 0 ? 1 : 0);
		}
		break;
	...
	const std::string& sect, const mrpt::config::CConfigFileBase* cfg) const
{
	...
	const std::string grab_type =
		cfg->read_string(sect, "grabber_type", "opencv");
	...
	else if (grab_type == "ffmpeg")
	{
		// Page: 1 (IP), 3 (file)
		const string url =
			cfg->read_string(sect, "ffmpeg_url", "rtsp://192.168.0.1/live.sdp");
	...
	else if (grab_type == "bumblebee")
	{
		...
		this->rbBumblebeeSel->SetSelection(
			cfg->read_int(sect, "bumblebee_mono", 0));
		this->cbBumblebeeRectif->SetValue(
			cfg->read_bool(sect, "bumblebee_get_rectified", false));
	}
	else if (grab_type == "swissranger")
	{
		...
		this->cbSR_chRange->SetValue(
			cfg->read_bool(sect, "sr_grab_range", false));
		this->cbSR_chConf->SetValue(
			cfg->read_bool(sect, "sr_grab_confidence", false));
	}
	else
		THROW_EXCEPTION_FMT(
			"Error: Unknown choice in 'grabber_type': '%s'", grab_type.c_str());

	// Grayscale option:
	this->cbGrayscale->SetValue(
		cfg->read_bool(sect, "capture_grayscale", false));
